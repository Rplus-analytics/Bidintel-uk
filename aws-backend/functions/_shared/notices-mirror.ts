// Mirrors tender rows into the notices table.
//
// PORTED BYTE-IDENTICAL from supabase/functions/_shared/notices-mirror.ts.
// No imports, database handle passed in as a parameter — nothing to convert.
