...
//
// Each opportunity is:
//   - upserted into raw_ccs_digital_outcomes (payload jsonb, unique by project_id)
//   - normalized into tenders_ccs (source = 'ccs_digital_outcomes')
//
// One invocation handles the entire catalogue: it's small (a few hundred rows).
